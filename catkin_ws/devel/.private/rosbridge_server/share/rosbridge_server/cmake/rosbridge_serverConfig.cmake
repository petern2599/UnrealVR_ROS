...
if("TRUE" STREQUAL "TRUE")
  set(rosbridge_server_SOURCE_PREFIX /home/petern25/catkin_ws/src/rosbridge_suite/rosbridge_server)
  set(rosbridge_server_DEVEL_PREFIX /home/petern25/catkin_ws/devel/.private/rosbridge_server)
  ...
  set(rosbridge_server_INSTALL_PREFIX /home/petern25/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/petern25/catkin_ws/src/rosbridge_suite/rosbridge_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/petern25/catkin_ws/devel/.private/rosbridge_server/lib;/home/petern25/catkin_ws/devel/lib;/opt/ros/melodic/lib)
